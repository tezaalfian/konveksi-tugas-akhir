                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
		                        <form action="<?= base_url('admin/pengiriman/tambah')?>" method="post" enctype="multipart/form-data">
		                            <div class="row">
		                                <div class="col-md-3">
			                                <div class="form-group">
		                                		<label for="desain">Desain</label>
		                            			<img src="<?=base_url('upload/pengiriman/default.jpg'); ?>" class="img-thumbnail" widht="100%">
