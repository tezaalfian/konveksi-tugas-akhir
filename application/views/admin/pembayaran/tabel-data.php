                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?= base_url('admin/pembayaran/tambah'); ?>">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($pembayaran as $order): ?>
                                            <tr>
                                                <td>
                                                    <?php echo strtoupper($order->id_pembayaran); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo $order->tanggal_pembayaran?>
                                                </td>
                                                <td>
                                                    diproses
                                                </td>
                                                <td align="center">
                                                    ...
                                                    <a href="<?= base_url('admin/pembayaran/edit/'.$order->id_pembayaran); ?>" class="btn btn-success btn-sm">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?= base_url('admin/pembayaran/delete/'.$order->id_pembayaran); ?>" class="btn btn-primary">
                                            Confirm
                                        </a>
                                    </div>
                                </div>
