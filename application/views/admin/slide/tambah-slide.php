            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/slide/tambah');?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card" style="border: solid #d4d4d4 1px;">
                                            <div class="card-body">
                                                <img width="100%" class="rounded" src="<?=base_url('upload/slide/default.png'); ?>"><br><br>
